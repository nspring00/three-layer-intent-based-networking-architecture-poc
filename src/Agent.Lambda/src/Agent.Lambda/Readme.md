...
Execute unit tests
```
cd "Agent.Lambda/test/Agent.Lambda.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "Agent.Lambda/src/Agent.Lambda"
